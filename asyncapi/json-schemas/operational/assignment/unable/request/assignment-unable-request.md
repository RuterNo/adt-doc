...
| Field         | Value                                                                                                                    |
|---------------|--------------------------------------------------------------------------------------------------------------------------|
| Central Topic | ruter/{operatorId}/back_office/adt/v3/operational/assignment/unable/request                                              |
| Schema        | [ assignment-unable-request.json ](json-schemas/operational/assignment/unable/request/assignment-unable-request.json)    |
| Producer      | PTO                                                                                                                      |
